...
function makeTournament(
  ...
  return {
    ...
    createdAt: iso(-3, 10),
    endsAt,
    format: "league_playoff" as const,
    id,
    location: "Club Padel La Elipa",
    mode,
    name,
    organizerId: DEMO_ORGANIZER_ID,
    pairMode: (mode === "fixed_pairs" ? "fixed" : "variable") as Tournament["pairMode"],
    slug: slugify(name),
    startsAt,
...
function seedFixedPairsTournament() {
  ...
  return {
    ...
    memberships,
    matchSides,
    proposals: [] as MatchResultProposal[],
    proposalValidations: [] as MatchResultValidation[],
    registrations: [] as TournamentRegistration[],
    rounds: [] as Round[],
    scoreSubmissions,
...
export function createDemoSeed() {
  ...
  return {
    ...
    profiles,
    proposals: [...fixed.proposals, ...individual.proposals],
    proposalValidations: [...fixed.proposalValidations, ...individual.proposalValidations],
    registrations: [...fixed.registrations, ...individual.registrations],
    rounds: [...fixed.rounds, ...individual.rounds],
